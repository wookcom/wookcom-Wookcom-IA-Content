...
function getAi(): GoogleGenAI {
  if (!process.env.API_KEY) {
    ...
    throw new Error("La API Key de Gemini no está configurada. Asegúrate de añadir la variable de entorno API_KEY en la configuración de tu proyecto en Vercel.");
  }
  if (!aiInstance) {
...
export const generateHooks = async (
  ...
  try {
    ...
    // Propagate the specific error message (e.g., from getAi or the API call itself)
    throw new Error(error instanceof Error ? error.message : "No se pudieron generar los hooks. Inténtalo de nuevo.");
  }
};
...
export const generateScriptForHook = async (
  ...
  try {
    ...
    if (result && result.intro && result.development && result.outro) {
      ...
      console.error("Unexpected JSON structure for script:", result);
    ...
    throw new Error(error instanceof Error ? error.message : "No se pudo generar el guion. Inténtalo de nuevo.");
  }
};

// ==================================================================
// NEW AD COPY CONSULTANT LOGIC
// ==================================================================
...
export const diagnoseAdScript = async (
  ...
  try {
    ...
    console.error("Error en diagnoseAdScript:", error);
    throw new Error(error instanceof Error ? error.message : "No se pudo diagnosticar el guion.");
  }
};
...
export const improveAdCopyAnswer = async (
  ...
  try {
    ...
    console.error("Error en improveAdCopyAnswer:", error);
    throw new Error(error instanceof Error ? error.message : "No se pudo mejorar la respuesta.");
  }
};
...
export const generateAdCopy = async (
  ...
  try {
    ...
    console.error("Error en generateAdCopy:", error);
    throw new Error(error instanceof Error ? error.message : "No se pudo generar el copy final.");
  }
};
